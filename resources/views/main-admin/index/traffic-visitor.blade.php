<div class="flex items-center justify-center mb-4 rounded-sm bg-gray-50 dark:bg-gray-800">
    <section class="bg-white dark:bg-gray-900 sm:px-6 py-8 w-full">
        <div class="">
            <div class=" w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
                <div class="flex justify-between mb-5">
                    <div>
                        <h5 class="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">Kunjungan Website</h5>
                        <p class="text-base font-normal text-gray-500 dark:text-gray-400">lorem</p>
                    </div>
                    <div

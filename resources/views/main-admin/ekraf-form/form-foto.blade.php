<div class="border-b border-gray-900/10 pb-12">
    <h2 class="flex items-center text-base/7 font-semibold text-gray-900 dark:text-white">Tambah Pelaku Ekraf
        <x-ui.popover id="informasi-usaha" :messages="[
            [
                'title' => 'Informasi Usaha',
                'desc' => 'Lengkapi informasi usaha anda untuk informasi yang lebih lengkap di halaman utama.',
            ],
        ]">
        </x-ui.popover>
    </h2>

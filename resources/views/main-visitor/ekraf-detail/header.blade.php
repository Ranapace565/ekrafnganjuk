<div class="">
    <div
        class="rounded-b-3xl border border-dashed border-gray-900/25 dark:border-gray-400 overflow-hidden bg-gray-100 as flex items-center justify-center relative aspect-[16/4]">

        <img id="cover-preview" class="w-full h-full object-cover"
            src="{{ asset('storage/ekrafs/covers/6qurJODGALuwukwknlLqc94XxP4ntxdfIYnsW0uD.webp') }}"
            alt="Preview Spanduk">
    </div>
    <div class="grid sm:grid-cols-6 ">
        <div class="col-span-2 p-2 -mt-16 relative z-10">
            @props([
                'id' => uniqid(),
                'size' => '',
                'title' => 'Judul Usaha',
            ...
            <div
                ...
                <div class="pt-6 flex justify-between flex-col">
                    ...
                    <div class="flex gap-2">
                        ...
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">
                            {{ Str::limit('wonghurip jangjanemong', 20, '...') }}</p>

...
<div class="mt-4 relative">
    <div
        class="rounded-lg border border-dashed border-gray-900/25 dark:border-gray-400 overflow-hidden bg-gray-100 {{ $size }} flex items-center justify-center relative">
        ...
        <div id="cover-placeholder" class="{{ $coverUrl ? 'hidden' : '' }} text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">'gambar 4:16'</p>

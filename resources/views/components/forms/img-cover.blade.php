<div class="mt-4 relative">
    <div
        class="rounded-lg border border-dashed border-gray-900/25 dark:border-gray-400 overflow-hidden bg-gray-100 aspect-[16/5] flex items-center justify-center relative">

        <!-- Tombol Hapus (X) -->
        <button type="button" id="reset-cover"
            class="absolute top-2 right-2 bg-white border border-gray-300 rounded-full p-1 text-gray-500 hover:text-red-600 hover:border-red-400 hidden z-10"
            title="Hapus gambar">
            &times;
        </button>

        <!-- Preview Gambar -->
        <img id="cover-preview" class="hidden w-full h-full object-cover" alt="Preview Spanduk">
        ...
        <div id="cover-placeholder" class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">PNG, JPG, atau GIF hingga 10MB</p>
        </div>
    </div>
    ...
    <div class="mt-2 flex justify-center text-sm text-gray-600">
        <label for="cover-upload"
            ...
            <span>Unggah Spanduk</span>
            <input id="cover-upload" name="cover" type="file" accept="image/*" class="sr-only">
        </label>
    </div>
</div>

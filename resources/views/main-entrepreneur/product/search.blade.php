<section class="bg-gray-50 dark:bg-gray-900 flex">
  <div class="max-w-screen-xl px-4 mx-auto lg:px-12 w-full">
    <!-- Start coding here -->
    <h2 class="flex items-center text-base/7 font-semibold text-gray-900 dark:text-white">Daftar Produk 
      <x-ui.popover id="daftar-produk" :messages="[
                ['title' => 'Daftar Produk', 'desc' => 'Produkmu akan ditampilkan di halaman utama usahamu.']
              ]">
              </x-ui.popover>
      </h2>
